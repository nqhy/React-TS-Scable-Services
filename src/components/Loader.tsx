...
const grow = (props: any) => keyframes`
  0% {
    height: 0;
    width: 0;
  }
...
const ripple = (props: any) => keyframes`
  0% {
    height: 0;
...
const LoaderGrow = styled.div`
  display: ${(props: any) => (props.block ? 'flex' : 'inline-flex')};
  height: ${(props: any) => px(props.size)};
  margin: ${(props: any) => (props.block ? '2rem' : 0)} auto;
  position: relative;
  width: ${(props: any) => px(props.size)};
  > div {
...
const LoaderPulse = styled.div`
  ...
  > div {
    ...
    border: ${(props: any) => px(Math.round(props.size / 16))} solid
